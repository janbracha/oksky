...
#crosswind calculation
    zbytek_uhlu_drahy = 360 -runway_magnetic_direction
    zbytek_uhlu_vetru= 360 - wind_derection
    ...
    crosswind_current = math.sin(rozdil_uhlu) * wind_velocity
    if crosswind_current <=0:
        crosswind_current = crosswind_current * -1
    else:
        crosswind_current = crosswind_current
...
hlavni_okno=Tk ()
hlavni_okno.title("OK-SKW Weight & balance open CARGO version   created by Jan Bracha Skysurf ltd. for any license queries refer to author honza@skysurf.cz")
